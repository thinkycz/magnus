            ...
            <ul class="relative">
                <li>
                    <a href="{{ route('student.courses.index') }}"
                       class="py-3 pl-1 w-full flex items-center text-gray-700 hover:text-gray-900 focus:outline-none focus-visible:underline {{ Request::routeIs('student.courses.*') ? 'text-green-600 hover:text-green-600' : '' }}">
