    ...
    <div class="container mx-auto pt-8">
        ...
        <div class="flex">
            ...
            <div class="w-full bg-white rounded-lg mx-auto my-8 px-10 py-8">
                <h1 class="text-2xl font-medium mb-2">Tiếng Séc giao tiếp A1</h1>
                <h2 class="font-medium text-sm text-gray-500 mb-4 uppercase tracking-wide">Khoá học của bạn</h2>
