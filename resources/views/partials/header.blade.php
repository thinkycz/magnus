        ...
        <div class="hidden lg:flex lg:items-center lg:w-auto w-full" id="menu">
            ...
            <div id="usermenu" class="absolute lg:mt-12 pt-1 z-40 left-0 lg:left-auto lg:right-0 lg:top-0 invisible lg:w-auto w-full">
                <div class="bg-white shadow-xl lg:px-8 px-6 lg:py-4 pb-4 pt-0 rounded rounded-t-none">
                    <a href="{{ route('profile.index') }}" class="pb-2 block text-gray-600 hover:text-gray-900 font-medium ignore-body-click">Cá nhân</a>
                    <a href="{{ route('logout') }}" class="block text-gray-600 hover:text-gray-900 font-medium ignore-body-click">Đăng xuất</a>
                </div>
            </div>
