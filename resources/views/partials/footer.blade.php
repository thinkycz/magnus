<footer class="bg-gray-900 text-white pt-12 pb-8 px-4">
    <div class="mx-auto px-4 container overflow-hidden flex flex-col lg:flex-row justify-between">
        ...
        <div class="w-2/3 block sm:flex text-sm mt-6 lg:mt-0">
            <div class="w-full">
                <p class="inline-block py-2 px-3 text-white uppercase font-medium tracking-wide">Liên hệ</p>
                <p class="inline-block py-2 px-3 text-gray-500">TTTM Sapa, nhà 7 tầng<br>Libušská 319/126<br>14200 Praha 4</p>
                <p class="inline-block py-2 px-3 text-gray-500">+420 728 005 266</p>
                <p class="inline-block py-2 px-3 text-gray-500">info@mgns.cz</p>
            </div>
            <ul class="text-gray-700 list-none p-0 font-thin flex flex-col text-left w-full">
                ...
                <li><a href="/p/privacy" class="inline-block py-2 px-3 text-gray-500 hover:text-white no-underline">Luyện nghe tiếng Séc</a></li>
                <li><a href="/p/terms" class="inline-block py-2 px-3 text-gray-500 hover:text-white no-underline">Luyện nói tiếng Séc</a></li>
                <li><a href="/p/terms" class="inline-block py-2 px-3 text-gray-500 hover:text-white no-underline">Phát âm tiếng Séc</a></li>
                <li><a href="/p/terms" class="inline-block py-2 px-3 text-gray-500 hover:text-white no-underline">Ngữ pháp tiếng Séc</a></li>
            </ul>
            <ul class="text-gray-700 list-none p-0 font-thin flex flex-col text-left w-full">
                <li class="inline-block py-2 px-3 text-white uppercase font-medium tracking-wide">Thông tin</li>
                <li><a href="#" class="inline-block py-2 px-3 text-gray-500 hover:text-white no-underline">Về TT Magnus</a></li>
                <li><a href="#" class="inline-block py-2 px-3 text-gray-500 hover:text-white no-underline">Các khoá học</a></li>
                <li><a href="#" class="inline-block py-2 px-3 text-gray-500 hover:text-white no-underline">Liên hệ</a></li>
                </li>
            </ul>
    ...
    <div class="pt-4 mt-4 pt-6 text-gray-600 border-t border-gray-800 text-center"> © 2019 Magnus. Všechna práva vyhrazena.</div>
</footer>
