    ...
    <div class="mx-auto px-4 container overflow-hidden flex flex-col lg:flex-row justify-between">
        ...
        <div class="w-1/2 block sm:flex text-sm mt-6 lg:mt-0">
            <ul class="text-gray-700 list-none p-0 font-thin flex flex-col text-left w-full">
                ...
                <li><a href="{{ route('category', 'luyen-nghe-tieng-sec') }}" class="inline-block py-2 px-3 text-gray-500 hover:text-white no-underline">Luyện nghe tiếng Séc</a></li>
                <li><a href="{{ route('category', 'luyen-noi-tieng-sec') }}" class="inline-block py-2 px-3 text-gray-500 hover:text-white no-underline">Luyện nói tiếng Séc</a></li>
                <li><a href="{{ route('category', 'phat-am-tieng-sec') }}" class="inline-block py-2 px-3 text-gray-500 hover:text-white no-underline">Phát âm tiếng Séc</a></li>
                <li><a href="{{ route('category', 'ngu-phap-tieng-sec') }}" class="inline-block py-2 px-3 text-gray-500 hover:text-white no-underline">Ngữ pháp tiếng Séc</a></li>
            </ul>
            <ul class="text-gray-700 list-none p-0 font-thin flex flex-col text-left w-full">
                ...
                <li><a href="{{ route('courses') }}" class="inline-block py-2 px-3 text-gray-500 hover:text-white no-underline">Các khoá học</a></li>
            </ul>
